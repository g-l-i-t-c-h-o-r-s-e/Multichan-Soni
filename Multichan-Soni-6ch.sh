...
ffmpeg -i $1 -f rawvideo -pix_fmt $2 -s $3 -r 25 -y output.raw

ffmpeg -f $4 -ar $5 -ac 6 -i output.raw \
...
ffmpeg -f $4 -ar $5 -ac 1 -i c-1.$4 -f $4 -ar $5 -ac 1 -i c-2.$4 -f $4 -ar $5 -ac 1 -i c-3.$4 -f $4 -ar $5 -ac 1 -i c-4.$4 -f $4 -ar $5 -ac 1 -i c-5.$4 -f $4 -ar $5 -ac 1 -i c-6.$4 -filter_complex \ "
...
-map [a] -f $4 -ar $5 -ac 6 - |
ffmpeg -f rawvideo -pix_fmt $2 -s $3 -r 25 -i - -c:v huffyuv -y MULTIOUT.avi
